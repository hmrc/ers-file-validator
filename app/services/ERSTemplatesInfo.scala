...
object ERSTemplatesInfo
    extends EMITemplateInfo with CsopTemplateInfo with SipTemplateInfo with OtherTemplateInfo with SayeTemplateInfo {

  val csopSheets: Map[String, SheetInfo] = Map(
    csopSheet1Name -> SheetInfo(
      csop,
      1,
      csopSheet1Name,
      csopSheet1title,
      csopSheet1ValConfig,
      csopOptionsGrantedHeaderRow
    ),
    csopSheet2Name -> SheetInfo(csop, 2, csopSheet2Name, csopSheet2Title, csopSheet2ValConfig, csopOptionsRCLHeaderRow),
    csopSheet3Name -> SheetInfo(
      csop,
      3,
      csopSheet3Name,
      csopSheet3Title,
      csopSheet3ValConfig,
      csopOptionsExercisedHeaderRow
    )
  )

  val csopSheetsV5: Map[String, SheetInfo] = Map(
    csopSheet1NameV5 -> SheetInfo(
      csop,
      1,
      csopSheet1NameV5,
      csopSheet1title,
      csopSheet1ValConfigV5,
      csopOptionsGrantedHeaderRowV5
    ),
    csopSheet2NameV5 -> SheetInfo(
      csop,
      2,
      csopSheet2NameV5,
      csopSheet2Title,
      csopSheet2ValConfig,
      csopOptionsRCLHeaderRow
    ),
    csopSheet3NameV5 -> SheetInfo(
      csop,
      3,
      csopSheet3NameV5,
      csopSheet3Title,
  ...
  val otherSheets: Map[String, SheetInfo] = Map(
    otherSheet1Name -> SheetInfo(
      other,
      1,
      otherSheet1Name,
      otherSheet1Desc,
      otherSheet1ValConfig,
      otherGrantsHeaderRow
    ),
    otherSheet2Name -> SheetInfo(
      other,
      2,
      otherSheet2Name,
      otherSheet2Desc,
      otherSheet2ValConfig,
      otherOptionsHeaderRow
    ),
    otherSheet3Name -> SheetInfo(
      other,
      3,
      otherSheet3Name,
      otherSheet3Desc,
      otherSheet3ValConfig,
      otherAcquisitionHeaderRow
    ),
    otherSheet4Name -> SheetInfo(
      other,
      4,
      otherSheet4Name,
      otherSheet4Desc,
      otherSheet4ValConfig,
      otherRestrictedSecuritiesHeaderRow
    ),
    otherSheet5Name -> SheetInfo(
      other,
      5,
      otherSheet5Name,
      otherSheet5Desc,
      otherSheet5ValConfig,
      otherBenefitsHeaderRow
    ),
    otherSheet6Name -> SheetInfo(
      other,
      6,
      otherSheet6Name,
      otherSheet6Desc,
      otherSheet6ValConfig,
      otherConvertibleHeaderRow
    ),
    otherSheet7Name -> SheetInfo(
      other,
      7,
      otherSheet7Name,
      otherSheet7Desc,
      otherSheet7ValConfig,
      otherNotionalHeaderRow
    ),
    otherSheet8Name -> SheetInfo(
      other,
      8,
      otherSheet8Name,
      otherSheet8Desc,
      otherSheet8ValConfig,
      otherEnhancementHeaderRow
    ),
...
object ERSValidationConfigs {
  ...
  def getConfig(sheetConfig: String): Config =
    ConfigFactory.load.getConfig(sheetConfig) // load new config per sheet on iteration
