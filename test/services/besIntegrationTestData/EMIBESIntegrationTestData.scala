...
trait EMIBESIntegrationTestData {
  ...
  val emiAdjustmentsExpData       = List(
    "yes",
    "yes",
    "yes",
    "4",
  ...
  val emiReplacedExpMandatoryData     = List(
    "2015-12-09",
    "2015-12-09",
    "John",
    "",
