...
import services.validation.CSOPTestData.{
  ERSValidationCSOPExercisedTestData, ERSValidationCSOPGrantedTestData, ERSValidationCSOPRCLTestData
}
import uk.gov.hmrc.services.validation.DataValidator
import uk.gov.hmrc.services.validation.models.{Cell, Row, ValidationError}

class CSOPOptionsGrantedValidationCSOPTest
    extends PlaySpec with ERSValidationCSOPGrantedTestData with ValidationTestRunner {
